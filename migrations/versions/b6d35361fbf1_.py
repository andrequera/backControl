...
Revision ID: b6d35361fbf1
Revises: 
Create Date: 2021-04-28 02:01:16.001505
...
def upgrade():
    ...
    sa.Column('caja', sa.Integer(), nullable=True),
    ...
    sa.Column('cantidad', sa.Integer(), nullable=True),
    sa.Column('sku', sa.String(length=50), nullable=True),
    sa.ForeignKeyConstraint(['sku'], ['inventario.sku'], ),
    sa.PrimaryKeyConstraint('id')
    )
